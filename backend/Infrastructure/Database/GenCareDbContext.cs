...
public class GenCareDbContext : DbContext, IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Appointment>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Member)
                .WithMany(p => p.AppointmentMembers)
        ...
        modelBuilder.Entity<BirthControl>(entity =>
        {
            ...
            entity
                .Property(e => e.EndSafeDate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("end_safe_date");
            entity
                .Property(e => e.EndUnsafeDate)
                .HasColumnType("timestamp without time zone")
            ...
            entity
                .Property(e => e.StartSafeDate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("start_safe_date");
            entity
                .Property(e => e.StartUnsafeDate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("start_unsafe_date");

            entity
                .HasOne(d => d.Account)
                .WithOne(p => p.BirthControl)
        ...
        modelBuilder.Entity<BlogTag>(entity =>
        {
            ...
            entity.ToTable(
                "blog_tag",
                tb =>
                    tb.HasComment("Join table for many-to-many relationship between blogs and tags")
            );
        ...
        modelBuilder.Entity<Conversation>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("gen_random_uuid()").HasColumnName("id");
            entity.Property(e => e.MemberId).HasColumnName("member_id");
            entity.Property(e => e.StaffId).HasColumnName("staff_id").IsRequired(false); // Allow NULL values
            entity
            ...
            entity
                .HasOne(d => d.Staff)
                .WithMany(p => p.ConversationStaffs)
                .HasForeignKey(d => d.StaffId)
                .OnDelete(DeleteBehavior.Restrict)
        ...
        modelBuilder.Entity<PaymentHistory>(entity =>
        {
            ...
            entity.Property(e => e.PurchaseId).ValueGeneratedNever().HasColumnName("purchase_id");
            ...
            entity
                ...
                .HasColumnName("created_at");
            entity
                .Property(e => e.ExpiredAt)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("expired_at");
            entity.Property(e => e.TransactionId).HasMaxLength(255).HasColumnName("transaction_id");
            entity.Property(e => e.Status).HasMaxLength(10).HasColumnName("status");
            entity.Property(e => e.PaymentMethod).HasMaxLength(10).HasColumnName("payment_method");
            entity.Property(e => e.PayId).HasMaxLength(255).HasColumnName("pay_id");
        ...
        modelBuilder.Entity<Result>(entity =>
        {
            ...
            entity
                .Property(e => e.ResultDate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("result_date");
            entity
                .Property(e => e.SampleDate)
                .HasColumnType("timestamp without time zone")
