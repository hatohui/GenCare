...
const AccountListHeader = ({
	...
	return (
		<div
			className='mx-2 bg-gradient-to-r from-white to-general overflow-hidden text-slate font-semibold px-4 py-2 flex justify-between drop-shadow-sm transition-colors duration-300 items-center relative rounded-[30px]'
