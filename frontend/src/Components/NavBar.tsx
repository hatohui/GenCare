...
const NavBar = () => {
	...
	return (
		<AnimatePresence>
			{showNav && (
				<motion.header
					className='fixed top-4 left-1/2 overflow-clip -translate-x-1/2 max-w-4xl px-4 py-2 rounded-full w-[90vw] z-40'
					initial='hidden'
				...
				>
					...
					>
						...
						<div>
							...
							<MobileMenu className='block md:hidden inset-0' onTop={onTop} />
						</div>
					</nav>
				</motion.header>
			)}
