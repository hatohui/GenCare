...
export default function TrustedBySection() {
	return (
		<section className='relative md:absolute py-10 bg-gradient-to-b from-white to-general text-center  px-6 rounded-[30px] md:w-7xl  mx-auto left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-2xl'>
