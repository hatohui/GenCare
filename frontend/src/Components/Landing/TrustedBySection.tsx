...
export default function TrustedBySection() {
	return (
		<section className='relative md:absolute py-10 bg-gradient-to-b from-white to-general text-center px-6 rounded-[30px] mx-auto md:w-3xl lg:w-6xl md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 shadow-2xl z-10'>
