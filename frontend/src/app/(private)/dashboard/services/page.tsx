...
// const ServicesPage = () => {
// 	const [services, setServices] = useState<Account[]>([])
...
// 	const currentAccounts = services.slice(indexOfFirstItem, indexOfLastItem)
...
// 		if (getAccountQuery.data) setServices(getAccountQuery.data.accounts)
