	...
	const recentActivity = [
		{
			id: 1,
			type: 'payment',
			message: 'Thanh toán thành công cho Nguyễn Thị A',
			time: '2 phút trước',
			status: 'success',
		},
		{
			id: 2,
			type: 'test',
			message: 'Kết quả xét nghiệm đã sẵn sàng cho Trần Văn B',
			time: '15 phút trước',
			status: 'success',
		},
		{
			id: 3,
			type: 'payment',
			message: 'Thanh toán thất bại cho Lê Thị C',
			time: '1 giờ trước',
			status: 'error',
		},
	]
	...
	const quickActions = [
		{
			...
			description: 'Xem và xử lý thanh toán của khách hàng',
		...
		},
		{
			...
			description: 'Quản lý và xem kết quả xét nghiệm',
		...
		<div className='max-w-7xl mx-auto p-6'>
			...
			>
				<h1 className='text-3xl font-bold text-main mb-2'>
					Chào mừng trở lại, {data?.firstName}!
				</h1>
			...
			>
				...
				<div className='bg-white border border-gray-200 rounded-[20px] p-6 shadow-sm hover:shadow-md transition-shadow'>
					<div className='flex items-center justify-between'>
						<div>
							<p className='text-sm text-gray-600'>Thanh toán hoàn thành</p>
				...
				<div className='bg-white border border-gray-200 rounded-[20px] p-6 shadow-sm hover:shadow-md transition-shadow'>
					<div className='flex items-center justify-between'>
						<div>
							<p className='text-sm text-gray-600'>Kết quả xét nghiệm</p>
